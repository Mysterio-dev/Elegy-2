 ...
 */
    ...
    (() => {
        ...
        let flatPlan = document.querySelectorAll(".flat__plan > .flat__plan-item");
        ...
        function closeFlatItem() {
            document.querySelectorAll(".flat__plan-item").forEach((function(e) {
                e.classList.remove("_active");
            }));
        }
        window.addEventListener("click", (function(e) {
            if (null === e.target.closest(".flat__plan-item")) closeFlatItem();
        }));
